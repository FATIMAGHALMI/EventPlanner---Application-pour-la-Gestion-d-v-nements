            ...
            <div class="relative min-h-screen flex flex-col items-center  selection:bg-[#FF2D20] selection:text-white">
                            ...
                            @if (Route::has('login'))
                                <nav class="mx-3 lg:col-start-3 gap-4  flex flex-1 justify-end">
                                    ...
                                    @else
                                        <a
                                            href="{{ route('login') }}"
                                            class="rounded-md text-gray-600 px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                        >
                                            Log in
                                        </a>
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl mt-24">
                        <main class="mt-6">
                            ...
                            <img src="{{ asset('image/homep.png') }}" alt="homep" class="  h-42">
                            </div>
                            <div class="bg-yellow-400 w-32  h-10 rounded-md flex justify-center ml-10">
                                        <a
                                            href="{{ route('login') }}"
                                            class="rounded-md text-gray-800 px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/40 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                        >
                                           Create Events
                                        </a> 
                            </div>
